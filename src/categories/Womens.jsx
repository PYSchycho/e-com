...
const WomensClothingPage = () => {
    ...
    useEffect(() => {
        const fetchWomens = async () => {
            try {
                ...
                if (!response.ok) {
                    throw Error('Failed to fetch Womens products');
                }
    ...
    return (
        <div>
            <Navbar />
            <h1 className="text-3xl font-bold text-center my-2 bg-blue-400 text-white p-1">Women's Products</h1>
                        ...
                        {filterProducts.map(product => (
                            <div key={product.id} className="border p-4 rounded-lg shadow-lg">
                                <img
                                    src={product.image}
                                    alt={product.title}
                                    className="w-48  h-44 border-2 mb-4 rounded-lg " />
